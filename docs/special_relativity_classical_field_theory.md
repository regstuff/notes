...
In matrix notation, this is written as $\Lambda^T\eta\Lambda=\eta$. Any matrix that satisfies this exact condition is a valid Lorentz transformation. In other words, any transformation that leaves the spacetime interval invariant satisfies it. 
